...
export class CustomValidator {
    ...
    static required(control: FormControl): ValidationResult | null {
    ...
    static numericValidation(control: FormControl): ValidationResult | null {
    ...
    static emailValidator(control: FormControl): ValidationResult | null {
    ...
    static clientEmailValidator(control: FormControl): ValidationResult | null {
    ...
    static MobilePhoneValidator(control: FormControl): ValidationResult | null {
    ...
    static passWordValidator(control: FormControl): ValidationResult | null {
